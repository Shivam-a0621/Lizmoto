...
--At first it user have to provide an input and area of information rquired.
--The user input is then fed to a langchain againt here  I have used duckduckgo web search
